...
main(int argc, char **argv)
{
	...
	case 0:
		...
		/*NOTREACHED*/
	default:
		fprintf(stdout, "waiting for rc process to complete...\n");
		wait(&rv); /* XXX */
		fprintf(stdout, "dropping to single user mode...\n");
		do_single();
	}
	return 20;
}
...
do_rc()
{
	...
	if (ret == 0)
		...
		case IMPORT_BOOT:
			fprintf(stdout, "loading /etc contents... done\n");
			fflush(stdout);
			break;
		}

	/* XXX */
	fprintf(stdout, "executing /etc/rc...\n");
