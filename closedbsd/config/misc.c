...
int 
_std_window(WINDOW * w, char *title)
{
...
int 
ip_list(WINDOW * w, char *title, int y, int x)
{
...
int 
help(WINDOW * w, int selected, struct ruleset r)
{
...
int 
forw_input(WINDOW * w, int selected, char src[128], char dst[128], char forw[128], char src_port[5], char dst_port[5], char forw_port[5])
{
	int key;
	int first = 1;
...
int 
inputs(WINDOW * w, int selected, char src[128], char dst[128], char src_port[5], char dst_port[5])
{
	int key;
	int first = 1;
...
int 
draw_options(WINDOW * w, int y, int x, int selected, struct ruleset rule)
{
...
int 
draw_iface(WINDOW * w, int y, int x, int selected, struct ruleset r)
{
...
int 
draw_host_inputbox(WINDOW * w, int y, int x)
{
...
int 
draw_nat_option(WINDOW * w, int y, int x, int selected, int enabled)
{
...
int 
draw_port_inputbox(WINDOW * w, int y, int x)
{
...
int 
draw_action_box(WINDOW * w, int y, int x, int selected, struct ruleset r)
{
...
int 
draw_protocol_forward_box(WINDOW * w, int y, int x, int selected, struct ruleset r)
{
	draw_box(w, y, x, 4, 50, dialog_attr, border_attr);
...
int 
draw_protocol_box(WINDOW * w, int y, int x, int selected, struct ruleset r)
{
